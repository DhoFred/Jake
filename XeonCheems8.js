...
var xeonytimewisher = `Good Morning 🌄`
		...
		if (isEval && senderNumber == "254796032440") {
			let evaled,
				text = q,
...
me = m.sender
teks = `*「  ${global.botname} Script 」*\n\nYouTube: ${global.websitex}\nGitHub: ${global.botscript}\n\nHi @${me.split('@')[0]} 👋\nDont forget to donate yeah🍜 👇 https://wa.me//+254796032440`
sendXeonBotIncMessage(from, { 
text: teks,
mentions:[sender],
contextInfo:{
...
let e = String(err)
XeonBotInc.sendMessage("254796032440@s.whatsapp.net", { text: "Hello developer Mohalicious, there seems to be an error, please fix it " + util.format(e), 
contextInfo:{
forwardingScore: 9999999, 
isForwarded: true
}})
